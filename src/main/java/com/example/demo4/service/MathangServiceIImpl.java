...
//   private Factory
	...
	@Override
	public List<MathangDTO> getmathang(Mathang mh, Banggia gia,Hinhanhmh hinhanhmh) {
		// TODO Auto-generated method stub
		...
		for(Banggia gia2:banggia2) {
			MathangDTO mathangDTO=mathangconvert.toDTO(mh, gia2,hinhAnhRepository.getHinhAnhByMH(gia2.getMathang().getMamh()));
...
//		MathangDTO mh3=mathangconvert.toDTO(mathang, gia);
	...
	@Override
	public MathangDTO getmathanggia(Mathang mh, Banggia gia,Hinhanhmh hinhanhmh) {
		// TODO Auto-generated method stub
		return mathangconvert.toDTO(mh, gia,hinhanhmh);
	}
//	@Override
//	public MathangDTO getmathangById(String id) {
//		// TODO Auto-generated method stub
//		return mathangRepository.get;
//	}
	@Override
	...
	@Override
	public void save(Mathang mh) {
		// TODO Auto-generated method stub
		mathangRepository.save(mh);
	}
	@Override
	public List<Mathang> getMHByNhan(String nhan) {
		// TODO Auto-generated method stub
		return mathangRepository.getMHByNhan(nhan);
	}
