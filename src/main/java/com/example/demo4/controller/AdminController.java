...
import com.example.demo4.service.ChatLieuService;
...
import com.example.demo4.service.NhanHieuService;
...
System.out.print(readPython.ReadPython(ProductBrand, Material, ProductionWay).toString()+"HUNG");
System.out.print("B");
mh.setNhan(label2);
//System.out.print("C");
...
//	}
   ...
   public String showProduct(Model model) {
	   ...
	   model.addAttribute("listnhanhieu", listnhanhieu);
	   return "views/home2";
   }
